<%@ Page ClassName="VehiculosAutorizadosadd" Language="C#" CodePage="65001" MasterPageFile="masterpage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="VehiculosAutorizadosadd.aspx.cs" Inherits="VehiculosAutorizadosadd" CodeFileBaseClass="AspNetMaker9_ControlVehicular" %>
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
<script type="text/javascript">
<!--

// Create page object
var VehiculosAutorizados_add = new ew_Page("VehiculosAutorizados_add");

// page properties
VehiculosAutorizados_add.PageID = "add"; // page ID
VehiculosAutorizados_add.FormID = "fVehiculosAutorizadosadd"; // form ID 
var EW_PAGE_ID = VehiculosAutorizados_add.PageID; // for backward compatibility

// extend page with ValidateForm function
VehiculosAutorizados_add.ValidateForm = function(fobj) {
...
VehiculosAutorizados_add.Form_CustomValidate =  
...
VehiculosAutorizados_add.ValidateRequired = true; // uses JavaScript validation
<% } else { %>
VehiculosAutorizados_add.ValidateRequired = false; // no JavaScript validation
<% } %>
...
<p class="aspnetmaker ewTitle"><%= Language.Phrase("Add") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= VehiculosAutorizados.TableCaption %></p>
<p class="aspnetmaker"><a href="<%= VehiculosAutorizados.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></p>
<% VehiculosAutorizados_add.ShowPageHeader(); %>
<% VehiculosAutorizados_add.ShowMessage(); %>
<form name="fVehiculosAutorizadosadd" id="fVehiculosAutorizadosadd" method="post" onsubmit="this.action=location.pathname;return VehiculosAutorizados_add.ValidateForm(this);">
<p />
...
dtlparms += "&confirmpage=" + ((VehiculosAutorizados_add.ConfirmPage) ? "1" : "0");
...
<%
VehiculosAutorizados_add.ShowPageFooter();
if (EW_DEBUG_ENABLED)
